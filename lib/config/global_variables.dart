...
List<AssetImage> backgroundImagesList = [
  blueBackgroundImage,
  redBackgroundImage,
...
AssetImage blueBrainLogoImage =
    AssetImage("assets/outlineDyslexiaBrainLogoBlue.png");
AssetImage redBrainLogoImage =
    AssetImage("assets/outlineDyslexiaBrainLogoRed.png");
AssetImage yellowBrainLogoImage =
    AssetImage("assets/outlineDyslexiaBrainLogoYellow.png");
AssetImage greenBrainLogoImage =
    AssetImage("assets/outlineDyslexiaBrainLogoGreen.png");
AssetImage purpleBrainLogoImage =
    AssetImage("assets/outlineDyslexiaBrainLogoPurple.png");
AssetImage pinkBrainLogoImage =
    AssetImage("assets/outlineDyslexiaBrainLogoPink.png");
AssetImage grayBrainLogoImage =
    AssetImage("assets/outlineDyslexiaBrainLogoGray.png");
AssetImage themeBrainLogoImage =
    AssetImage("assets/outlineDyslexiaBrainLogoTheme.png");
AssetImage currentBrainLogoImage;

List brainLogoImagesList = [
  blueBrainLogoImage,
  redBrainLogoImage,
  yellowBrainLogoImage,
  greenBrainLogoImage,
  purpleBrainLogoImage,
  pinkBrainLogoImage,
  grayBrainLogoImage,
  themeBrainLogoImage
];
...
LetterSet singleConsonantsEnding = LetterSet("Single Consonants", end, [
  "b",
  "c",
  "d",
  "f",
...
LetterSet hBrothers =
    LetterSet("H Brothers", sides, ["ch", "ph", "sh", "th", "wh"]);
LetterSet beginningBlends = LetterSet("Beginning Blends", beginning, [
  "bl",
  "br",
  "cl",
  "cr",
...
LetterSet shortVowelPointers = LetterSet("Short Vowel Pointers", latterHalf,
    ["ck", "dge", "tch", "ff", "ll", "ss", "zz"]);
LetterSet endingBlends = LetterSet("Ending Blends", end,
    ["sk", "sp", "st", "ct", "ft", "lk", "lt", "mp", "nch", "nd", "nt", "pt"]);
LetterSet magicEEnding = LetterSet("Magic E", end,
    ["be", "ce", "de", "fe", "ge", "ke", "le", "me", "ne", "pe", "se", "te"]);
LetterSet closedSyllable =
    LetterSet("Closed Syllable", middle, ["a", "e", "i", "o", "u"]);
LetterSet openSyllable =
    LetterSet("Open Syllable", middle, ["a", "e", "i", "o", "u"]);
LetterSet magicEMiddle =
    LetterSet("Magic E", middle, ["a", "e", "i", "o", "u", "y"]);
LetterSet controlledR =
    LetterSet("Controlled R", middle, ["ar", "er", "ir", "or", "ur"]);
LetterSet shortVowelExceptions = LetterSet("Short Vowel Exceptions", middle, [
  "ang",
  "ank",
  "ild",
  "ind",
...
LetterSet vowelTeamBasic = LetterSet(
    "Vowel Team Basic", middle, ["ai", "ay", "ea", "ee", "igh", "oa", "oy"]);
LetterSet vowelTeamIntermediate = LetterSet("Vowel Team Intermediate", middle,
    ["aw", "ei", "eigh", "ew", "ey", "ie", "oe", "oi", "oo", "ou", "ow"]);
LetterSet vowelTeamAdvanced = LetterSet("Vowel Team Advanced", middle,
    ["aw", "ei", "eigh", "ew", "ey", "ie", "oe", "oi", "oo", "ou", "ow"]);
LetterSet vowelA = LetterSet("Vowel A", middle, ["al", "all", "wa"]);
LetterSet empty = LetterSet("Empty", all, [" ", " ", " ", " "]);

List<LetterSet> allSets = [
  singleConsonantsBeginning,
  singleConsonantsEnding,
  hBrothers,
  beginningBlends,
  endingBlends,
  magicEEnding,
  ...
  shortVowelPointers,
  controlledR,
  shortVowelExceptions,
  vowelTeamBasic,
  vowelTeamIntermediate,
  vowelTeamAdvanced,
  vowelA,
  empty
];
...
LetterPack standardOpen = LetterPack("Standard (Open Syllable)",
    singleConsonantsBeginning, openSyllable, singleConsonantsEnding);
LetterPack blendingDemo = LetterPack(
    "Blending Demo",
    LetterSet("Bl", beginning, ["bl"]),
    LetterSet("e", middle, ["E"]),
    LetterSet("Nd", beginning, ["nd"]));
